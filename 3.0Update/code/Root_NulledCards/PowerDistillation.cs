...
namespace RootNulledCards {
    public class PowerDistillation : OnAddEffect
	{
	    ...
	    {
	        Core.instance.StartCoroutine(addRandomCards(player, gun, gunAmmo, data, health, gravity, block, characterStats));
	    }
	    ...
	    public bool condition(CardInfo card, Player player, Gun gun, GunAmmo gunAmmo, CharacterData data, HealthHandler health, Gravity gravity, Block block, CharacterStatModifiers characterStats)
	    {
	        ...
	        return (card.rarity == CardInfo.Rarity.Rare) && !card.categories.Intersect(Core.NoLotteryCategories).Any() && card != CardList.GetCardInfo("Integraty");
